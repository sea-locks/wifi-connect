...
* Removed Apple portal detection addresses from special list to test if this fixes iPhone portal showing up. [Samuel Weibel]
* Delete only the right AP profile on start [Zahari Petkov]


## v4.2.11 - 2019-09-19

* Added special addresses to dnsmasq configuration to fix the portal on Android. [Samuel Weibel]

## v4.2.10 - 2019-09-18

* Add "/stop" endpoint to stop the application from outside. [Samuel Weibel]
